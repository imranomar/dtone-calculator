...
<div class="container">
    ...
    <div class="col-sm-6 offset-sm-3 text-center shadow" style="background-color: orange; border-radius: 12px; ">
        ...
        <form id="form" method="get" action="">
          <div id="report-app" class="d-flex flex-row form-group">
            ...
            <div class="p-4">
              <div>or Week</div>
              <input class=" form-control" type="text"  :class="[selectedType=='week' ? 'selectedType' : '' ]"  id="selectedWeek" v-model="selectedWeek" value="{{$selectedDate}}" autocomplete="off" name="selectedWeek"  >
            </div>
            <div class="p-4">
              <div>or Month</div>
    ...
    <div class="row mt-4">
      <div class="col-12 text-center" >
        ...
        @if($selectedType=='week')
          <h3>Week Report:  {{\Carbon\Carbon::parse($from)->format('M-d-Y')}} to {{\Carbon\Carbon::parse($to)->format('M-d-Y')}}</h3>
        @endif
  ...
  <div class="row  mt-3">
    <div class="col-sm-12 text-center shadow" style="background-color: darkturquoise; border-radius: 12px; ">
      <table class="report-table table thead-dark  table-striped" style="width: 100%">
        <thead>
        <th>Date</th>
        <th>End Point</th>
        <th>Number 1</th>
    ...
    mounted() {
      ...
      $('input[name=selectedDate]').datepicker({
        ...
        onSelect: function(dateText) {
          ...
          // const today1 = moment(dateText);
          // const today2 = moment(dateText);
          // const from_date = today1.startOf('isoWeek');
          // const to_date = today2.endOf('isoWeek');
      ...
      $('input[name=selectedWeek]').datepicker({
        showWeek: true,
        changeMonth: true,
        changeYear: true,
        firstDay: 1,
